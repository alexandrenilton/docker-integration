...
LABEL "Maintainer"="Alexandre Belem"
...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/docker-git-hello-world-1.0.0-SNAPSHOT-jar-with-dependencies.jar", "me.learn.docker.HelloWorldPing"]


#Comandos para build de image e executar container
